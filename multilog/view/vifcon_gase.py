...
class Vifcon_gaseWidget(QWidget):
    ...
    def set_initialization_data(self, sampling):
        ...
        self.pressure_widget.set_label("DM21", "{:.5g}".format(sampling["DM21"]))
        self.pressure_widget.set_label("PP21", "{:.5g}".format(sampling["PP21"]))
        self.pressure_widget.set_label("PP22", "{:.5g}".format(sampling["PP22"]))
    ...
    def set_measurement_data(self, rel_time, meas_data):
        ...
        self.pressure_widget.set_data("DM21", rel_time, "{:.5g}".format(meas_data["DM21"]))
        self.pressure_widget.set_data("PP21", rel_time, "{:.5g}".format(meas_data["PP21"]))
        self.pressure_widget.set_data("PP22", rel_time, "{:.5g}".format(meas_data["PP22"]))
